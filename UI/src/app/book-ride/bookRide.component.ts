...
export class BookRideComponent implements OnInit {
  ...
  constructor(public http: RestService, public route: Router,public mapsAPILoader: MapsAPILoader,
    ...
    //                       car:'Jeep Cherokee',
    //                       license:'IL12930ND',
    //                       carImage:'https://mystrongad.com/seo-specials/hvm-2019grandcherokee-special.png'
    //                     },
    //                     {
    //                       passengerCount: 2,
    //                       driverName: 'Tim',
    //                       rating:4.6,
    //                       car:'Chevrolet Traverse',
    //                       license:'NV3423J',
    //                       carImage:'https://s.aolcdn.com/dims-global/dims3/GLOB/legacy_thumbnail/788x525/quality/85/https://s.aolcdn.com/commerce/autodata/images/CAC60CHS291A021001.jpg'
    //                     },
    //                     {
    //                       passengerCount: 3,
    //                       driverName: 'Abdul',
    ...
    //                       license:'IL3423J',
    //                       carImage:'https://upload.wikimedia.org/wikipedia/commons/5/5e/2019_Chevrolet_Camaro_2SS_6.2L_front_3.16.19.jpg'
    //                     },
    //                     {
    //                       passengerCount: 4,
    //                       driverName: 'Steve',
    ...
    //                       car:'Toyota Camry',
    //                       license:'SJ3423J',
    //                       carImage:'https://file.kelleybluebookimages.com/kbb/base/evox/ExtSpP/12105/2020-Toyota-Camry-360SpinFrame_12105_032_2400x1800.png'
    //                     },
    //                     {
    //                       passengerCount: 5,
    //                       driverName: 'Mike',
    ...
    //                       license:'IL12930ND',
    //                       carImage:'https://st.motortrend.com/uploads/sites/10/2015/11/2012-chevrolet-impala-lt-sedan-angular-front.png'
    //                     },
    //                     {
    //                       passengerCount: 6,
    //                       driverName: 'Theiry Henry',
    //                       rating:4.8,
    //                       car:'Jeep Cherokee',
    //                       license:'CA1224K',
    //                       carImage:'https://content.autotrader.com/content/dam/autotrader/articles/OversteerImages/2018/May/CheapestElectrics/volt.jpg'
    //                     },
    //                     {
    //                       passengerCount: 7,
    //                       driverName: 'Daniel James',
    //                       rating:4.6,
    //                       car:'Lexus RX RX 350 F Sport',
    //                       license:'WA1998A',
    //                       carImage:'https://9e59a6be9d5449310956-e1f1a2f001d94011e35e09c0b10e271b.ssl.cf1.rackcdn.com/2T2BZMCA5KC179893/1a2cbebacb4f74ec8b5279e12360961f.jpg'
    //                     }
    //                   ]
  ...
  confirmBooking(){
    Swal({
      title: 'Confirm Booking with '+this.selectedDriver.username,
      ...
      cancelButtonText: 'Cancel'
        ...
        this.dataObj.customer = JSON.parse(localStorage.getItem("login")).username;
        this.dataObj.driver = this.selectedDriver.username;
        ...
        this.http.bookACab(this.dataObj).subscribe(
          (response)=>{
            ...
            Swal(
              'Booking Confirmed',
              this.selectedDriver.username+' will pick you up in ' +this.pickUpTime+ ' Minutes',
              'success'
            ).then((newResult)=>{
              this.route.navigate(['/allRides']);
            })
